...
/**
 * check_value - Check the numerical val of a card.
...
/**
 * insert_sort_deck - Sort a deck of cards from spades to diamonds.
...
/**
 * insertion_sort_deck_val - Sort a deck of cards sorted from
